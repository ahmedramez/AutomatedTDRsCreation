...
var UIController = (function () {
    ...
    } //return global values & function return { getIputs:
    function() { //catch budget input return { type: document.querySelector(DOMString.inputType).value, desc:
        document.querySelector(DOMString.inputDesc).value, value:
        parseFloat(document.querySelector(DOMString.inputValue).value)
    };
}, //return DOMString to be global getDoms:
    function () { return DOMString; }, displayMonth: function() {
        var now, month, months, year; months = ['Jan', 'Feb'
            , 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']; now = new Date();
        month = now.getMonth(); year = now.getFullYear(); document.querySelector(DOMString.dateLabel).textContent = months[month]
            + ' ' + year;
    },
